// test avec le pipe qui return une fonction async et le handler qui retourne une fonction async
// ca permet de faire const dockerPs = docker().ps() ... await dockerPs() et pareil pour le pipe
